...
namespace BG\Barcode\Tests;

require(__DIR__.'/../Util/Base1DBarcode.php');
require(__DIR__.'/../Util/Base2DBarcode.php');
 ...
 */
class BGBarcodeGeneratorUnitTests extends \PHPUnit_Framework_TestCase
{
